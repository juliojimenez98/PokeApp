  ...
  return (
    <div className="flex">
      <div className="mx-auto">
        ...
        <button
          onClick={next}
          class="ml-2 p-0 w-10 h-10 text-white bg-red-600 rounded-full hover:bg-yellow-400 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
